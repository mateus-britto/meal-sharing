...
VALUES (
        'Pasta Night',
        'Delicious Italian pasta dishes',
        'Downtown Restaurant',
        '2023-10-01 19:00:00',
        20,
        15.99,
...
-- Alter some meal dates to fulfill the exercise requirements.
UPDATE meal SET `when` = '2025-10-05 18:30:00' WHERE id = 2;

UPDATE meal SET `when` = '2025-10-05 19:30:00' WHERE id = 4;

UPDATE meal SET `when` = '2025-10-05 19:00:00' WHERE id = 5;
...
UPDATE meal SET title = 'Barbecue Adventure' WHERE id = 6;
...
UPDATE reservation SET number_of_guests = 6 WHERE id = 1;
...
VALUES (
    ...
    (
        'BBQ Bliss',
        'The barbecue was smoky and flavorful.',
        3,
        5,
        '2023-09-27'
    ),
    (
        'Vegan Surprise',
        'The vegan dishes were surprisingly tasty.',
        4,
        4,
        '2023-09-28'
    ),
...
SET
    title = 'Average Pasta',
    description = 'The Pasta was acceptable'
WHERE
    id = 1;
...
SELECT * FROM meal WHERE title like '%Night%'
...
FROM meal
WHERE
    created_date BETWEEN '2023-09-21' AND '2023-09-23';
...
-- Consider 3+ to be a good review

-- Get reservations for a specific meal sorted by created_date
SELECT * FROM reservation WHERE id = 2 ORDER BY created_date;
